    ...
    return (
        <div className='m-5 w-60'>
            ...
            {favStudent.map((item, index) => (
                <div className='flex w-60 p-1 items-center justify-between'>
                    <div className='flex'>
                    <h2 className=' flex text-lg p-2 items-center mr-1'>{star}</h2>
                    <h2 className=' flex text-lg p-2 items-center'>{item.name}</h2>
                    </div>
